...
export const EditRoleModal: React.FC<EditRoleModalProps> = ({
  ...
  const [permissions, setPermissions] = useState<PermissionFeature[]>([...role.permissions]);
  ...
  const loadData = async () => {
    try {
      const categoriesData = await RolePermissionService.getPermissionsByCategory();
          ...
          {role.isBuiltIn && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                This is a built-in role. You can edit permissions but the basic structure is protected.
              </p>
            </div>
          )}
